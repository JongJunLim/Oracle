[max_date]
CASE 1=1
WHEN [P_Q/M] = '0' THEN DATETRUNC('year',DATEPARSE('yyyyMMdd',[P_Year]+[C_Y/Q_치환]+'31')+1)-1
WHEN [P_Q/M] IN ('Q1','Q2','Q3','Q4') THEN DATETRUNC('quarter',DATEPARSE('yyyyMMdd',[P_Year]+[C_Y/Q_치환]+'01'))
ELSE DATETRUNC('month',DATEADD('month',1,DATEPARSE('yyyyMMdd',[P_Year]+[C_Y/Q_치환]+'01')))
END

[min_date]
CASE 1=1
WHEN [P_Q/M] = '0' THEN DATEADD('year',-5,[C_Max_Date])
WHEN [P_Q/M] IN ('Q1','Q2','Q3','Q4') THEN DATEADD('quarter',-4,[C_Max_Date])
ELSE DATEADD('month',-12,[C_Max_Date])
END
